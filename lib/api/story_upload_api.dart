...
class StoryUploadService{
  static Future<dynamic> uploadStory(filePath) async {
    ...
    try {
      ...
      Response response =
      await Dio().post(
          "$baseUrlWithHttps/pettyapp/api/add_story",
          data: formData,
          queryParameters: {'id': PettySharedPref.getUserId(prefs), 'token': PettySharedPref.getAccessToken(prefs)},
          options: Options(
