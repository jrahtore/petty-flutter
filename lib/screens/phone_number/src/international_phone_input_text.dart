...
class InternationalPhoneInputText extends StatefulWidget {
  final Function(String number, String internationalizedPhoneNumber, String isoCode) onValidPhoneNumber;
...
class _InternationalPhoneInputTextState
  ...
  Future<String> _validatePhoneNumber(
      String number, List<Countryy> countries) async {
    String fullNumber;
    if (number != null && number.isNotEmpty) {
      //This step to avoid calling async function on the whole list of countries
      List<Countryy> potentialCountries = PhoneService.getPotentialCountries(number, countries);
