...
//   image: new ExactAssetImage('assets/userimages/women1.jpeg'),
//   fit: BoxFit.cover,
// );
DecorationImage image2 = new DecorationImage(
  image: new ExactAssetImage('assets/userimages/women5.jpeg'),
  fit: BoxFit.cover,
);

DecorationImage image3 = new DecorationImage(
  image: new ExactAssetImage('assets/userimages/women3.jpeg'),
  fit: BoxFit.cover,
);
DecorationImage image4 = new DecorationImage(
  image: new ExactAssetImage('assets/userimages/image3.png'),
  fit: BoxFit.cover,
);
DecorationImage image5 = new DecorationImage(
  image: new ExactAssetImage('assets/userimages/image2.png'),
  fit: BoxFit.cover,
);
DecorationImage image6 = new DecorationImage(
  image: new ExactAssetImage('assets/images/vinu.jpeg'),
  fit: BoxFit.cover,
);
DecorationImage image7 = new DecorationImage(
  image: new ExactAssetImage('assets/userimages/women6.jpeg'),
  fit: BoxFit.cover,
);
DecorationImage image8 = new DecorationImage(
  image: new ExactAssetImage('assets/userimages/women2.jpeg'),
  fit: BoxFit.cover,
);
